    ...
    <div className="flex flex-col h-full bg-white border-l border-gray-200">
          ...
          <div className="space-y-2.5 mt-3">
            ...
            <MetaRow label="上傳者" value={
              <div className="flex items-center gap-1.5">
                <div className="w-5 h-5 rounded-full flex items-center justify-center text-white flex-shrink-0" style={{ fontSize: "9px", fontWeight: 700, backgroundColor: "var(--color-primary)" }}>
                  {meta.uploader[0]}
                </div>
      ...
      <div className="px-5 py-4 border-t border-gray-100 flex-shrink-0 space-y-2.5">
        ...
        <button
          ...
          style={{ backgroundColor: "var(--color-primary)", fontWeight: 600, fontSize: "13px" }}
        >
...
function DecisionResult({ type, onReset }: { type: "approved" | "rejected"; onReset: () => void }) {
  ...
  return (
    <div className="flex flex-col h-full bg-white border-l border-gray-200 items-center justify-center px-6 text-center">
      ...
      >
        {isApproved ? (
          <CheckCircle2 size={32} style={{ color: "var(--color-primary)" }} strokeWidth={1.5} />
        ) : (
