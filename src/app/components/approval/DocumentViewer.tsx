      ...
      <div className="flex-1 overflow-auto flex items-start justify-center py-8 px-4">
        ...
        >
          ...
          <div className="p-8 space-y-5">
            ...
            <div className="flex items-start justify-between pb-5 border-b-2" style={{ borderColor: "var(--color-primary)" }}>
              <div>
            ...
            <div className="border border-gray-200 rounded overflow-hidden">
              <div className="grid grid-cols-4 gap-px" style={{ backgroundColor: "#E2E8F0" }}>
                {["項目", "說明", "金額", "備註"].map((h) => (
                  <div key={h} className="px-3 py-2 text-xs font-semibold text-white" style={{ backgroundColor: "var(--color-primary)" }}>
                    {h}
                  </div>
                ))}
            ...
            >
              {[60, 85, 45, 95, 70, 55, 80].map((h, i) => (
                <div
                  ...
                  style={{
                    height: `${h}%`,
                    backgroundColor: i === 4 ? "var(--color-primary)" : "#CBD5E0",
                    opacity: 0.7,
                  }}
                />
              ))}
