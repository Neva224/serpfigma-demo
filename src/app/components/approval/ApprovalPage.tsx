      ...
      <header className="bg-white border-b border-gray-200 shadow-sm flex-shrink-0 z-20">
        <div className="flex items-center justify-between px-6 h-14">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <span
                  ...
                  style={{ fontSize: "10px", fontWeight: 700, backgroundColor: "var(--color-primary)" }}
                >
                  文件審核
                </span>
              </div>
          ...
          <div className="hidden md:flex items-center gap-1.5 text-xs text-gray-400">
            <span>首頁</span>
            <span>/</span>
            <button onClick={onBack} className="hover:underline" style={{ color: "var(--color-primary)" }}>文件管理</button>
            <span>/</span>
