...
const ROLE_COLORS: Record<Role, { bg: string; text: string }> = {
  ...
  文管人員:   { bg: "var(--color-primary)", text: "#ffffff" },
        ...
        {ROLES.map((role) => {
          ...
          return (
            <div key={role} className="enterprise-panel flex flex-col items-center gap-2 rounded-xl p-4">
              ...
              <p className="text-slate-800 text-center leading-tight" style={{ fontSize: "12px", fontWeight: 700 }}>{role}</p>
        ...
        <div className="enterprise-section-header flex items-center justify-between px-5 py-3">
          <div className="space-y-1.5">
            ...
            <div className="flex flex-wrap items-center gap-3 text-xs text-slate-500">
              ...
              <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-2.5 py-1 font-semibold text-slate-600">
          ...
          <button
            ...
            style={{
              ...
              borderColor: editing ? "var(--color-primary)" : "#CBD5E1",
              backgroundColor: editing ? "#E6FFFB" : "#FFFFFF",
              color: editing ? "var(--color-primary)" : "#64748B",
            }}
          >
            <Edit2 size={12} />
            {editing ? "儲存變更" : "編輯權限"}
                      ...
                      {ROLES.map((role) => (
                        <td key={role} className="px-4 py-2.5 text-center">
                          <button
                            ...
                            style={{
                              backgroundColor: perm.roles[role] ? "var(--color-primary)" : "#E2E8F0",
